	...
	<BODY>
			      ...
			      <ul class="nav navbar-nav navbar-right">
			        ...
			        <li class="active dropdown">
			          ...
			          <ul class="dropdown-menu">
			            <li><a href="../View/login.php"><i class="fa fa-user fa-fw"></i> Iniciar</a></li>
		...
		<main id="body" class="col-lg-12 nopadding">
				...
				<div class="col-lg-12 row nopadding jumbotron style="margin-top: 5em;">
				  <h1 class="text-center"> <small class="text-success" style="opacity: 0.8;"> Recuperar Contraseña </small></h1>
				</div>

			<!-- FORMULARIO -->
				<div class="col-lg-12 row">
					<div class="col-lg-8 col-lg-offset-2">
						<form method="POST" action="../../Controller/clientes/recuperar_pwd.php">
							 <div class="form-group">
							    <label>E-mail</label>
