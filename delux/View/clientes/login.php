	...
	<BODY>
		...
		<main id="body" class="col-lg-12 nopadding">
				...
				<div class="col-lg-12 row nopadding jumbotron style="margin-top: 5em;">
				  <h1 class="text-center"> <small class="text-success" style="opacity: 0.8;"> Iniciar sesión </small></h1>
				</div>

			<!-- FORMULARIO -->
				<div class="col-lg-12 row">
					<div class="col-lg-8 col-lg-offset-2">
						<form method="POST" action="../../Controller/clientes/login_cliente.php">
							 <div class="form-group">
							    <label>E-mail</label>
							    <input type="email" class="form-control" name="cliente_email" placeholder="E-mail">
							 </div>
							 <div class="form-group">
							    <label>Password</label>
							    <input type="Password" class="form-control" name="cliente_password" placeholder="Password">
							 </div>
							 <button type="submit" class="btn btn-primary">Iniciar Sesion</button>

							 <p class="margin-top"><small><a href="recuperar_pwd.php"> ¿ Ha olvidado su contraseña ?</a></small></p>
